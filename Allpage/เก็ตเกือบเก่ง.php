...
<head>
    ...
    <meta name='description' content='กดหกดก'>
    <meta name='keywords' content='กดหดหกดห'>
    <title>กดห</title>
    <style>
        [contenteditable] {
...
<header>
    <h1 contenteditable="true">กดหกดหก</h1>
    <h2 contenteditable="true">ดหกดหกด</h2>
</header>
<div class="content">
    <p contenteditable="true">หกหกดผ</p>
    <div class="left">
        <img src="จัดการหน้าเว็บ/images_all/462574549_504611285935765_4198341142524739233_n.jpg" alt="Left Image" style="max-width: 300px;">
        <p contenteditable="true">กดหกดห</p>
    </div>
    <div class="right">
        ...
        <p contenteditable="true">ดหดหกด</p>
    </div>
</div>
<!-------เพิ่มโค๊ดข้างล่าง----------------->
