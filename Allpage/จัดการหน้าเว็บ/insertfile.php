...
<body>
    <div class="Allfrom">
        ...
        <div class="FromFilemanager">
            ...
            <button type="button" onclick="toggleForm('pageForm')" class="btn btn-secondary">
                เปิด/ปิด ฟอร์ม
            </button>

            <!-- ฟอร์มที่ต้องการพับเก็บ -->
            <div id="pageForm" style="display: none; margin-top: 10px;">
...
<style>
        ...
        .FromFilemanager {
            display: flex;
            flex-direction: column; /* เปลี่ยนเป็น column เพื่อให้ปุ่มอยู่บนและฟอร์มอยู่ล่าง */
        ...
        * {
        ...
        form {
            background: #fff;
            padding: 20px;
            width: 100%; /* ปรับเป็น 100% เพื่อให้ฟอร์มใช้พื้นที่ทั้งหมดในคอนเทนเนอร์ */
