...
<head>
    ...
    <meta name='description' content='dfdgdfg'>
    <meta name='keywords' content='fdgd'>
...
<div class="content">
    <p><?php echo htmlspecialchars("dsgsdgsdgds", ENT_QUOTES, 'UTF-8'); ?></p>
    <div class="left">
        ...
        <p><?php echo htmlspecialchars("fdgdfgdfsgdfg", ENT_QUOTES, 'UTF-8'); ?></p>
    </div>
    <div class="right">
        <img src="จัดการหน้าเว็บ/<?php echo htmlspecialchars('images_all/462574549_504611285935765_4198341142524739233_n.jpg', ENT_QUOTES, 'UTF-8'); ?>"
             alt="Right Image" style="max-width: 300px;">
        <p><?php echo htmlspecialchars("fdgdfgdfgdfg", ENT_QUOTES, 'UTF-8'); ?></p>
    </div>
</div>
