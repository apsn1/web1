...
<head>
    ...
    <meta name='description' content='ssdsd'>
    <meta name='keywords' content='eere'>
...
<div class="content">
    <p >www</p>
    <div class="left">
        <img src="จัดการหน้าเว็บ/images_all/5983.jpg" alt="Left Image" style="max-width: 300px;">
        <p >rrr</p>
    </div>
    <div class="right">
        <img src="จัดการหน้าเว็บ/images_all/14287.jpg" alt="Right Image" style="max-width: 300px;">
        <p >rtrtr</p>
    </div>
</div>
<!-------เพิ่มโค๊ดข้างล่าง----------------->
